...
import { Plus, Search, Refresh, Edit, Delete, Picture as IconPicture, View } from "@element-plus/icons-vue";
...
const getTableData = async () => {
  let url = `/travelGuide/page?pageNum=${params.value.pageNum}&pageSize=${params.value.pageSize}`;
  ...
  <div>
    <header class="flex">
      <div class="flex form-item">
        ...
        <el-input v-model="params.title" placeholder="请输入攻略标题" clearable @keyup.enter="handleSearch" />
      </div>
      <div class="flex form-item">
      ...
      <div class="flex form-item">
        <p class="label-text">分类：</p>
        <el-select v-model="params.categoryId" placeholder="请选择分类" clearable style="width: 200px;">
          <el-option
    ...
    <main>
      <div class="flex op-box">
        <el-button
          v-if="hasPermission('travelGuide', '新增')"
          :icon="Plus"
          type="primary"
          @click="handleAdd"
          >新增</el-button
        >
        <el-button
          v-if="hasPermission('travelGuide', '删除')"
          :icon="Delete"
          type="danger"
      ...
      >
        ...
        <el-table-column label="操作" fixed="right" width="240">
          <template #default="scope">
            <el-button
              v-if="hasPermission('travelGuide', '编辑')"
              type="primary"
              :icon="Edit"
